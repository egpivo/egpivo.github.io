...
<div style="text-align:center;">
  <img src="{{ site.baseurl }}/assets/2025-11-06-context-aware-retriever-mcp-iii/eval_workflow.dot.svg" alt="Evaluation workflow overview">
  <div style="font-style: italic; font-size: 0.95em; margin-top: 4px;">Figure 1. Evaluation workflow overview.</div>
</div>
...
<div style="text-align:center;">
  <img src="{{ site.baseurl }}/assets/2025-11-06-context-aware-retriever-mcp-iii/eval_flow.dot.svg" alt="Entity extraction flow">
  <div style="font-style: italic; font-size: 0.95em; margin-top: 4px;">Figure 2. Entity extraction flow.</div>
</div>
...
<div style="text-align:center;">
  <img src="{{ site.baseurl }}/assets/2025-11-06-context-aware-retriever-mcp-iii/base_workflow.png" alt="Standard Dify workflow">
  <div style="font-style: italic; font-size: 0.95em; margin-top: 4px;">Figure 3. Standard Dify: single‑pass semantic search with Jina rerank; GPT‑4o summarization.</div>
</div>

<div style="text-align:center;">
  <img src="{{ site.baseurl }}/assets/2025-11-06-context-aware-retriever-mcp-iii/context_aware_workflow.png" alt="Context‑Aware workflow">
  <div style="font-style: italic; font-size: 0.95em; margin-top: 4px;">Figure 4. Context‑Aware: GPT‑4o agent orchestrates MCP service: multi‑stage retrieval with query expansion and reflection.</div>
</div>
