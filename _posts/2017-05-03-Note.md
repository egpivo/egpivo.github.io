...
(<span class="inlinecode">$\theta$</span>) of a model and observed data (<span class="inlinecode">$D$</span>)

An "activation function" is a function applied at each node. For example, a rectified linear unit  (reLU) function is defined as
<div>
{% raw %}
...
Let's see the difference b/w these two functions. We will consider $$256$$ values of $$x$$ from $$-5$$ to $$5$$ equally spaced. 
