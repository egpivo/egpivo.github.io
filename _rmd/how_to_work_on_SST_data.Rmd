...
```
```{r eof1, fig.width = 10, fig.height = 5, message = FALSE, warning = FALSE, fig.align="center",fig.asp = 1}
# plot the first EOF
...
```
```{r eof2, fig.width = 10, fig.height = 5, message = FALSE, warning = FALSE, fig.align="center",fig.asp = 1}
# plot the second EOF
